...
import com.project.demo.util.IpUtil;
...
public class UserController extends BaseController<User, UserService> {
    ...
    public Map<String, Object> login(@RequestBody Map<String, String> data, HttpServletRequest request) {
        ...
        if (byUsername.getPassword().equals(md5password)) {
            ...
            ret.put("obj",user);
            //访问加1
            String address = IpUtil.getGeoByIP(IpUtil.getIpAdrress(request));
            ...
            accessMap.put("user_location",address);
            accessMap.put("access_period",dateStr);
            List accessList = accessDataService.select(accessMap, new HashMap<>()).getResultList();
            if (accessList.size()<1){
                AccessData accessData = new AccessData();
                accessData.setUser_location(address);
                accessData.setNumber_of_visitors(1);
//                Map<String,Object> addMap = new HashMap<>();
//                addMap.put("access_period",dateStr);
//                addMap.put("user_location",address);
//                addMap.put("number_of_visitors",1);
                accessDataService.save(accessData);
            }else {
                AccessData accessData = (AccessData) accessList.get(0);
                accessData.setNumber_of_visitors(accessData.getNumber_of_visitors()+1);
                accessDataService.saveUpdate(accessData,"access_data_id",String.valueOf(accessData.getAccess_data_id()));
            }
