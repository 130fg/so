...
//        sql.append(";");
    ...
    @Transactional
    public void saveUpdate(E e,String idName,String idValue){
        String s = JSONObject.toJSONString(e);
        Map map = JSONObject.parseObject(s, Map.class);
        map.remove("access_data_id");
        map.remove("access_period");
        map.remove("create_time");
        map.remove("update_time");
        Map<String,String> queryMap = new HashMap();
        queryMap.put(idName,idValue);
        update(queryMap,new HashMap<>(),map);
    }
