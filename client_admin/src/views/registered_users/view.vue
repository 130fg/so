		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="用户编号" prop="user_no">
												<el-input id="user_no" v-model="form_sub['user_no']" placeholder="请输入用户编号"
							  v-if="user_group === '管理员' || (form_sub['registered_users_id'] && $check_field('set','user_no')) || (!form_sub['registered_users_id'] && $check_field('add','user_no'))" :disabled="true"></el-input>
					<div v-else-if="$check_field('get','user_no')">{{form_sub['user_no']}}</div>
											</el-form-item>
			</el-col>
