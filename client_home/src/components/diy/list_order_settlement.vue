<template>
	<div class="diy_home diy_list diy_order_settlement" id="diy_order_settlement_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/order_settlement/details?order_settlement_id=' + o['order_settlement_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/order_settlement/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/order_settlement/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
						<th class="diy_title" v-if="$check_field('get','number')">
						编号
					</th>
							<th class="diy_title" v-if="$check_field('get','name')">
						名称
					</th>
						...
						合计金额
							...
							<th class="diy_title" v-if="$check_field('get','annotation_notes')">
						标注说明
					</th>
					</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						<td class="diy_field diy_text" v-if="$check_field('get','number')">
						<span>
							{{ o["number"] }}
						</span>
					</td>
							<td class="diy_field diy_text" v-if="$check_field('get','name')">
						<span>
							{{ o["name"] }}
						</span>
					</td>
						...
						<span>
							...
							<td class="diy_field diy_date" v-if="$check_field('get','purchase_time')">
						<span>
						...
						<span>
							...
							<td class="diy_field diy_text" v-if="$check_field('get','annotation_notes')">
						<span>
							{{ o["annotation_notes"] }}
						</span>
					</td>
