<template>
	<div class="diy_details_box diy_div_thematic_activities">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/registration_record/edit','add')" @click="to_form('/registration_record/edit')" > 报名 </button>
											<button class="btn btn-primary details_btn" v-if="$check_action('/thematic_activities/details','set')" @click="change_praise()" >点赞</button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/thematic_activities/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var thematic_activities_id = this.obj.thematic_activities_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "thematic_activities",
          source_field: "thematic_activities_id",
          source_id: thematic_activities_id
        }, (res) => {
