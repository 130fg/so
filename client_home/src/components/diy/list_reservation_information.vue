			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						姓名
							...
							<th class="diy_title" v-if="$check_field('get','check_in_time')">
						入住时间
					</th>
				...
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<span>
							...
							<td class="diy_field diy_text" v-if="$check_field('get','advance_deposit')">
						<span>
							{{ o["advance_deposit"] }}
						</span>
					</td>
						...
						<span>
							...
							<td class="diy_field diy_date" v-if="$check_field('get','check_in_time')">
						<span>
							{{ $toTime(o["check_in_time"] ,"yyyy-MM-dd") }}
						</span>
					</td>
