<template>
	<div class="diy_home diy_list diy_tourism_sharing" id="diy_tourism_sharing_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/tourism_sharing/details?tourism_sharing_id=' + o['tourism_sharing_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/tourism_sharing/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/tourism_sharing/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						类型
							...
							<th class="diy_title" v-if="$check_field('get','tourist_location')">
						旅游地点
					</th>
						...
						姓名
									...
									<th class="diy_title" v-if="$check_field('get','resource_acquisition')">
						资源获取
					</th>
							</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<span>
							...
							<td class="diy_field diy_text" v-if="$check_field('get','tourist_location')">
						<span>
							{{ o["tourist_location"] }}
						</span>
					</td>
						...
						<span>
							{{ o["full_name"] }}
									...
									<td class="diy_field diy_text" v-if="$check_field('get','resource_acquisition')">
						<span>
							{{ o["resource_acquisition"] }}
						</span>
					</td>
							</tr>
			</table>
