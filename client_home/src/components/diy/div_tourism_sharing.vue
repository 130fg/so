<template>
	<div class="diy_details_box diy_div_tourism_sharing">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/tourism_sharing/details','set')" @click="change_praise()" >点赞</button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/tourism_sharing/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var tourism_sharing_id = this.obj.tourism_sharing_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "tourism_sharing",
          source_field: "tourism_sharing_id",
          source_id: tourism_sharing_id
        }, (res) => {
