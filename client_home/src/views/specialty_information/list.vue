<template>
	<div class="diy_list page_specialty_information" id="specialty_information_list">
		<div class="warp">
			<div class="container diy_list_container">
				<div class="diy_list_title">
					<div class="col">
						<span class="title">特产信息列表</span>
					</div>
				</div>
					...
					<div class="col">
						...
						<div class="view">
							<span class="diy_list_search_title">关键字搜索：</span>
								<b-form-input size="sm" class="mr-sm-2" placeholder="编号搜索" v-model="query['number']" />
									<b-form-input size="sm" class="mr-sm-2" placeholder="名称搜索" v-model="query['name']" />
    ...
    font-size: 22px;">排序</div>
				...
				<div class="row diy_list_box">
					<div class="col">
						<!-- 列表 -->
						<list_specialty_information :list="list" />
						<!-- /列表 -->
					</div>
				</div>
