<template>
	<div class="diy_details page_specialty_information" id="specialty_information_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_specialty_information'>
							<div_specialty_information :obj="obj"></div_specialty_information>
...
<script>
	import div_specialty_information from "@/components/diy/div_specialty_information.vue";
	...
	export default {
		...
		methods:{
			...
			add_hits(obj) {
				obj["hits"] = obj["hits"] + 1;
				var hits = obj["hits"];
				this.$post('~/api/specialty_information/set?specialty_information_id=' + obj["specialty_information_id"], {
					hits
				}, (res) => {
					if(res.result){
			...
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.specialty_information_id;
				}
			},
			/**
			 * 初始化收藏状态
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "specialty_information",
					source_field: "specialty_information_id",
					source_id: obj["specialty_information_id"],
					user_id
				};
