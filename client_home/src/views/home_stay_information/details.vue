<template>
	<div class="diy_details page_home_stay_information" id="home_stay_information_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_home_stay_information'>
							<div_home_stay_information :obj="obj"></div_home_stay_information>
...
<script>
	import div_home_stay_information from "@/components/diy/div_home_stay_information.vue";
	...
	export default {
		...
		methods:{
			...
			add_hits(obj) {
				obj["hits"] = obj["hits"] + 1;
				var hits = obj["hits"];
				this.$post('~/api/home_stay_information/set?home_stay_information_id=' + obj["home_stay_information_id"], {
					hits
				}, (res) => {
					if(res.result){
			...
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.home_stay_information_id;
				}
			},
			/**
			 * 初始化收藏状态
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "home_stay_information",
					source_field: "home_stay_information_id",
					source_id: obj["home_stay_information_id"],
					user_id
				};
